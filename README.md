# Hi there, I'm Pamella 👋

### ✦ Things I build

`UI/UX` `IoT` `Embedded Systems` `Web Apps` `Machine Learning` `AI Systems`

🌐 **Personal Website:** [pamellazhr.com](https://pamellazhr.com)  
💼  **LinkedIn:** [LinkedIn](https://www.linkedin.com/in/pamellazahara/) <br/>
📩 **Mail:** (pamellazahara.work@gmail.com)

Coming from a **Vocational High School background in Software Engineering**, 
I'm now pursuing **Computer Science** and continuing to explore the intersection 
of software, AI, IoT, and design.
...
## Pamella's Stats:
![](https://github-readme-stats.shion.dev/api?username=PamellaCodes&theme=dark&hide_border=false&include_all_commits=false&count_private=false)
![](https://streak-stats.demolab.com/?user=PamellaCodes&theme=dark&hide_border=false)<br/>
